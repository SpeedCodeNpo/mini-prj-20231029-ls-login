...
- Chapter id: chp-01--skeleton
- Chapter name: Generate app skeleton
- Source: YTB: Learn from Scratch (Oct 4, 2023) 
- In video this chapter starts here : https://youtu.be/P1r2QjuJWcI?t=407
- 3rd Party: 
...
- (1) Generate login, register, home comp
- (2) Generate auth service and guards (CanActivate)
- (3) Generate interface for auth
